...
```sh
make docker-build docker-push IMG=<some-registry>/plugin-mongodb:tag
```
...
```sh
make deploy IMG=<some-registry>/plugin-mongodb:tag
```
...
```sh
make build-installer IMG=<some-registry>/plugin-mongodb:tag
```
